  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen p-4 overflow-hidden bg-slate-100 dark:bg-slate-900 font-sans">
      ...
      <div className="relative w-full max-w-md z-10 my-auto">
        ...
        {/* Main Card */}
        <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-6 sm:p-8 transition-all duration-500 max-h-[85vh] flex flex-col">
          ...
          {/* Google Login - Always available in Login/Register */}
            ...
            <div className="mt-6">
                <div className="relative mb-4">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-400 bg-opacity-100 backdrop-blur-xl">
                            ou continue com
                        </span>
                    </div>
                </div>
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full flex items-center justify-center px-4 py-3 border border-slate-200 dark:border-slate-600 rounded-xl shadow-sm bg-white hover:bg-slate-50 dark:bg-slate-700 dark:hover:bg-slate-600 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 active:scale-[0.98]"
                >
                    ...
                    <span className="text-slate-700 dark:text-white font-medium">Entrar com Google</span>
                </button>
            </div>
          )}
